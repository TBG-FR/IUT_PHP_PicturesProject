        ...
        <section>   <! --- Section : Conteneur central du site --- >
            ...
            <div class="bloc_articles"> <! --- Bloc contenant tous les articles --- >
                ...
                <article class="preface">    <! --- Article de préface --- >
                    <p>
                        Vous retrouverez ici tous les articles concernant les Mangas & les Animes.<br />
                        One piece, Death Note, Naruto ou encore Fairy Tail, retrouvez ici vos mangas préférés !<br />
                        <em>~~ Bonne lecture ! ~~</em>
                    </p>
                </article>
					
                <?php include("articles.php"); ?> <! --- Affichage de tous les articles concernant les Mangas --- >
