...
if (isset($_GET['modifier_news'])) // Si on demande de modifier une news.
{
    ...
    $miniature = stripslashes($donnees['miniature']);
...
<p>Auteur : <input type="text" size="20" name="auteur" value="<?php echo $auteur; ?>" /></p>
<p>
...
<p>Miniature : <input type="text" size="30" name="miniature" placeholder="URL Complète de l'image de miniature" value="<?php echo $miniature; ?>" /></p>
<p>
    Contenu :<br />
