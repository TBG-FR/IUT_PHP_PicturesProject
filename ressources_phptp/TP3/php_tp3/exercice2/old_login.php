...
<body>
    ...
    */ ?>
    ...
    if( $row[1]==$login and $row[2]==$pass ) { $correctlogin=TRUE;}
            ...
            foreach($req as $row)
    {
        ...
        echo "<p class='success'>Identification Effectuée ! <br /></p>
            <p class='warning'> /!\ Accès en tant qu'Administrateur /!\ <br /></p>";
